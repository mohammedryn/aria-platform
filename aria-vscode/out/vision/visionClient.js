...
class VisionClient {
    static async analyze(base64Image) {
        try {
            const result = await geminiClient_1.GeminiClient.analyzeImage(base64Image, this.SYSTEM_PROMPT);
            ...
            logger_1.Logger.log(`[VisionClient] Analysis failed: ${e}`);
            return {
                detectedBoards: [],
                detectedComponents: [],
                confidence: 0,
