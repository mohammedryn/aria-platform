...
exports.WokwiGenerator = void 0;
const path = require("path");
const fs = require("fs");
class WokwiGenerator {
    static generate(workspaceRoot, boardId, validationResult) {
        ...
        if (!wokwiBoardId) {
            if (normalizedBoardId.includes("nano"))
                wokwiBoardId = "wokwi-arduino-nano";
            else if (normalizedBoardId.includes("uno"))
                wokwiBoardId = "wokwi-arduino-uno";
            else if (normalizedBoardId.includes("mega"))
                wokwiBoardId = "wokwi-arduino-mega";
            else if (normalizedBoardId.includes("esp32"))
                wokwiBoardId = "board-esp32-devkit-c-v4";
            else if (normalizedBoardId.includes("esp8266"))
                wokwiBoardId = "board-esp8266";
            else if (normalizedBoardId.includes("pico"))
                wokwiBoardId = "board-pi-pico";
            else if (normalizedBoardId.includes("teensy"))
                wokwiBoardId = "board-teensy41";
            else
                wokwiBoardId = "wokwi-arduino-uno"; // Safe default
        }
        // 2. Build Parts List
        const parts = [
    ...
    static createProjectFiles(workspacePath, content, boardId) {
...
//# sourceMappingURL=wokwiGenerator.js.map