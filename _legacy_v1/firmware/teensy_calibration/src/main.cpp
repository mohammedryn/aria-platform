...
// const int PIN_BASE       = 2; // DISABLED: Stepper used for base (Step/Dir)
...
void setup() {
  ...
  // Base - NEMA 17 Stepper (Skip calibration, it has no 'center')
...
void loop() {
  ...
  // Periodically reinforce the signal (not strictly necessary with Servo lib,
  // but good safety) base.write(90);
  shoulder.write(90);
  elbow.write(90);
  wrist_pitch.write(90);
  wrist_roll.write(90);
